...
function ProductsCatalogContent() {
  ...
  // Sync selectedCategory with URL query param whenever it changes
  useEffect(() => {
    if (categoryParam) {
  ...
  const defaultCategories = ['ALL', 'DUVETS', 'BEDSHEETS', 'PILLOWS'];
  ...
  const sortedProducts = [...filteredProducts].sort((a, b) => {
    ...
    if (sortBy === 'price-high') return b.price - b.price ? b.price - a.price : 0;
    if (sortBy === 'name') {
